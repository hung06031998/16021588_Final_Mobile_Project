                    ...
                    Expanded(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(snapshot.data.documents[index]["speakers"], textAlign: TextAlign.left, style: TextStyle(color: Colors.white)),
                            Text(snapshot.data.documents[index]["name"], textAlign: TextAlign.left, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                    ),
